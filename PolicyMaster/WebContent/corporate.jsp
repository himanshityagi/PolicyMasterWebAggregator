...
<h3>Your details</h3>
	 <li>
							...
							<div class="w3ls-text w3ls-name">
								<span class="agile_sub-label1">
									<select name="insurance" class="day">
	...
	<li>	
		...
		<div class="w3ls-name">	
			<input type="text" name="person"  placeholder="Enter Contact Person Name" required=" "/>
		</div>
	</li>
 ...
 <li>
	...
	<div class="wthree-text">
						...
						<ul class="radio-w3ls">
							<li>
								<input type="radio" id="Yes" name="type" value="fresh">
								 <label for="Yes">Fresh</label>	
								<div class="check"></div>
							</li>
							<li>
								<input type="radio" id="No" name="type" value="renewal"> 
