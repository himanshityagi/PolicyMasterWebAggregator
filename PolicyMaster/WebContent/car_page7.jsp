    ...
    <div class="row">
        <div class="col-md-6">
            <form action="Servlet1" method="post">
                ...
                <center> 
                    <button id="btn2" class="btn btn-success" type="submit" name="Claim" value="YES">YES</button>
                    <div class="dropdown">
                    <button id="btn2" class="btn btn-success" class="btn btn-primary dropdown-toggle" name="Claim" data-toggle="dropdown">NO</button>
...
$(document).ready(function(){
	$('.dropdown-item').click(function(){
		var id = $(this).data('id');
		//alert(id);
		var myform = '<form class="myform" action="Servlet1" method="post"><input type="text" value="'+id+'" name="Claim"></form>';
